...
int main() {
  ...
  while (true) {
    if (flag1) {
      ...
      att_est.read();
      hor_est.read(att_est.Phi, att_est.Theta, att_est.P, att_est.Q, ver_est.z);
    ...
    //   hor_est.estimate(att_est.Phi, att_est.Theta, att_cont.f_x, att_cont.f_y)
      hor_est.estimate(att_est.Phi, att_est.Theta, 0.0, 0.0);
    ...
    //   bt.printf("vel_x=%f, vel_x_hat= %f, vel_y= %f, vel_y_hat= %f\n\r", hor_est.vel_x, hor_est.estimated_x[1], hor_est.vel_y, hor_est.estimated_y[1]);
         bt.printf("%f %f\n\r", hor_est.estimated_x[0], hor_est.estimated_y[0]);
        // bt.printf("%f %f\n\r", hor_est.vel_y, hor_est.vel_y_hat);
