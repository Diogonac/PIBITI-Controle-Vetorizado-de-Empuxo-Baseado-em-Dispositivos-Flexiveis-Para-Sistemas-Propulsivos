...
public:
    ...
    // double K_theta[3] = {1149.2749228701122774509713053703, 413.74609133969096319560776464641, 26.96}; // Ts = 1.0s OS = 0.5%;; Bom 
       double K_theta[3] = {-0.26215351874228415285372761900362, 0.10648542361424691293780853129647, 0.0}; // Ts = 1.0s OS = 0.5%;; Bom 
